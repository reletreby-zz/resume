...
\resumeItemListStart
\resumeItemInfo{(J6)}{\textbf{R. Eletreby}, Y. Zhuang, K. M. Carley, O. Ya\u{g}an, and H.  Vincent Poor \textit{``The Effects of Evolutionary Adaptations on Spreading Processes in Complex Networks"} - Proceedings of the National Academy of Sciences}

\resumeItemInfo{(J5)}{\textbf{R. Eletreby} and O. Ya\u{g}an \textit{``Secure Connectivity of Heterogeneous Wireless Sensor Networks Under a Heterogeneous On-Off Channel Model"} - submitted to IEEE Transactions on Information Theory}


\resumeItemInfo{(J4)}{\textbf{R. Eletreby} and O. Ya\u{g}an \textit{``Connectivity of Inhomogeneous Random K-out Graphs"} - submitted to IEEE Transactions on Information Theory}


\resumeItemInfo{(J3)}{\textbf{R.Eletreby} and O.Ya\u{g}an \textit{``$k$-connectivity of Inhomogeneous Random Key Graphs with Unreliable Links"} - published in IEEE Transactions on Information Theory}

\resumeItemInfo{(J2)}{\textbf{R.Eletreby} and O.Ya\u{g}an \textit{``Connectivity of Wireless Sensor Networks Secured by Heterogeneous Key Predistribution Under an On/Off Channel Model"} - published in IEEE Transactions on Control of Network Systems}


\resumeItemInfo{(J1)}{\textbf{R.Eletreby}, H.Elsayed and M.Khairy \textit{``Optimal Spectrum Assignment for Cognitive Radio Sensor Networks Under Coverage Constraint"} - published in IET Communications Journal}
...
\resumeItemListStart
\resumeItemInfo{(C12)}{\textbf{R.Eletreby} and O.Ya\u{g}an \textit{``Connectivity of Inhomogeneous Random $K$-out Graphs"} - IEEE ISIT 2019}
...
\resumeItemInfo{(C5)}{\textbf{R.Eletreby} and O.Ya\u{g}an \textit{``Reliability of Wireless Sensor Networks under a Heterogeneous Key Predistribution Scheme"} - IEEE CDC 2016}


\resumeItemInfo{(C4)}{\textbf{R.Eletreby} and O.Ya\u{g}an \textit{``Performance of the Heterogeneous Key Predistribution Scheme under a Heterogeneous ON-OFF Channel Model"} - Allerton 2016}
